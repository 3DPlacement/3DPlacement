...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{ContourList_8h__dep__incl}
\end{center}
\end{figure}
\subsection*{Classes}
...
\begin{DoxyCompactList}\small\item\em Defines a vertical contour doubly-\/linked list. \end{DoxyCompactList}\item 
